...
###### IoT Frameworks/Architectures/Systems, Python, JSON

### Lab
The goal of the lab is to gather humidity/temperature data and send to a server, request and push processes the query. The data are generated by sensors on different stations.

<img src="../assets/img/TNK116 Internet of Things Lab.jpg" width="560">

### Assignment
The goal of the assigment is to design an IoT system that monitors traffic on a single city street. The purpose of this assignment is to derive an architectural model starting from the design of the domain model and provide an information model as well.

<img src="../assets/img/TNK116 Internet of Things Assignment.jpg" width="560">
...
### Project
Non-player characters (NPC) that players can interact with, or the opponents that players face in a single player campaign, all have some degrees of artificial intelligence. The goal of the project is to develop a 2D puzzle game with AI agents. The fundamental idea is to place boxes at specific platforms to open gates. The report is available [here](https://drive.google.com/file/d/1oDVmy6tTppEWStxL3Kirn3-4DUcm3XuO/view?usp=sharing) (in English).

<img src="../assets/img/TSBK03 Advanced Game Programming Project.gif" width="560">
